...
import {useToggle, useWindowSize, useDebounceFn} from '@vueuse/core'
import 'uno.css'
        ...
        <section class="flex h-full flex-row items-center justify-center">
          ...
          <div class="w-[400px] h-full px-6 py-12 flex flex-col items-center bg-gray-100 dark:bg-gray-700">
            <div class="aspect-square w-full">
              <img v-if="cropImg" width="100%" height="100%" ref="preview" :src="cropImg" alt="">
            </div>
            <textarea v-model="code" rows="2"
            ...
            <div class="w-full grid grid-cols-2 p-0">
              ...
              ><span>Copy</span>
                <svg v-if="!clipboardCopied" xmlns="http://www.w3.org/2000/svg"
                     class="w-6 h-6"
                     fill="currentColor"
                     viewBox="0 0 24 24"
                >
